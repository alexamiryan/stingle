...
"Austria", "Australia", "Aruba", "Azerbaijan", "Bosnia and Herzegowina",
"Barbados", "Bangladesh", "Belgium", "Burkina Faso", "Bulgaria", "Bahrain",
"Burundi", "Benin", "Bermuda", "Brunei Darussalam", "Bolivia", "Brazil",
"Bahamas", "Bhutan", "Bouvet Island", "Botswana", "Belarus", "Belize",
"Canada", "Cocos (Keeling) Islands", "Congo, The Democratic Republic of the",
"Central African Republic", "Congo", "Switzerland", "Cote D'Ivoire", "Cook
Islands", "Chile", "Cameroon", "China", "Colombia", "Costa Rica", "Cuba", "Cape Verde",
...
"Latvia", "Libyan Arab Jamahiriya", "Morocco", "Monaco", "Moldova, Republic of", "Madagascar", "Marshall Islands", "Macedonia",
...
"Uzbekistan", "Vatican City State (Holy See)", "Saint Vincent and the
...
function geoip_country_name_by_code($gi, $code) {
  if (isset($gi->GEOIP_COUNTRY_CODE_TO_NUMBER[strtoupper($code)])) {
