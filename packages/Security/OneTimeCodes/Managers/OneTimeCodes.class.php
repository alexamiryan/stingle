...
class OneTimeCodes extends DbAccessor {
	...
	public function cleanUp() {
		...
		$andX1->add($qb->expr()->equal(new Field('multi'), 1));
		$andX1->add($qb->expr()->isNotNull(new Field('usage_limit')));
		$andX1->add($qb->expr()->greaterEqual(new Field('usage_count'), new Field('usage_limit')));
